document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      var existingAlert = contactForm.querySelector('.form-alert');
    ...
    contactForm.addEventListener('input', function(e) {
      var field = e.target;
      if (field.closest && (field.name === 'name' || field.name === 'email' || field.name === 'message')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '58c0d304-3c58-4b1b-b06d-5b30b4ba8415',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '58c0d304-3c58-4b1b-b06d-5b30b4ba8415';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '58c0d304-3c58-4b1b-b06d-5b30b4ba8415';
